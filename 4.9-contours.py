...
img_temp = cv2.imread(r'pictures\cat.jpg')
...
contours, hierarchy = cv2.findContours(
    thresh, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)  # works in OpenCV 4
...
cont_all = cv2.drawContours(img, contours, -1, (0, 255, 0), 3)

# draw an individual contour, say 4th contour here
cont_4th = cv2.drawContours(img, contours, 3, (0, 255, 0), 3)
